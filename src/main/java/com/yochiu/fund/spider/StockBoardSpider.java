...
public class StockBoardSpider {
    ...
    private static Set<String> FILTER_BOARD = Sets.newHashSet("融资融券", "富时概念", "深股通", "AH股", "贵州板块", "湖南板块", "湖北板块", "滨海新区", "河南板块", "陕西板块", "江西板块", "京津冀", "内蒙古", "山西板块",
            "甘肃板块", "海南板块", "江西板块", "标普概念", "基金重仓", "深成500", "MSCI中国", "证金持股", "沪股通", "HS300_", "创业板综", "山东板块", "雄安新区", "上证50_", "国企改革", "长江三角", "湖南板块", "上海板块",
            "中证500", "MSCI大盘", "广东板块", "MSCI中盘", "QFII重仓", "创业成份", "机构重仓", "江苏板块", "工业4.0", "四川板块", "上证180_", "天津板块", "新疆板块", "安徽板块",
            "深证100R", "上证180", "上证380", "股权激励", "次新股", "央视50_", "北京板块", "浙江板块", "深圳特区", "转债标的", "上海板块", "重庆板块", "成渝特区", "福建板块");
